...
import de.pascxl.minecraft.minecore.config.converter.Array;
import de.pascxl.minecraft.minecore.config.converter.Converter;
import de.pascxl.minecraft.minecore.config.converter.Primitive;
...
public class InternalConverter {
    ...
    public InternalConverter() {
        try {
            ...
            addConverter(de.pascxl.minecraft.minecore.config.converter.Config.class);
            addConverter(de.pascxl.minecraft.minecore.config.converter.List.class);
            addConverter(de.pascxl.minecraft.minecore.config.converter.Map.class);
            addConverter(Array.class);
            addConverter(de.pascxl.minecraft.minecore.config.converter.Set.class);
